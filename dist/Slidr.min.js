...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t=e(require("./Slide"));function e(t){return t&&t.__esModule?t:{default:t}}var i=function(){return(i=Object.assign||function(t){for(var e,i=1,n=arguments.length;i<n;i++)for(var o in e=arguments[i])Object.prototype.hasOwnProperty.call(e,o)&&(t[o]=e[o]);return t}).apply(this,arguments)},n=function(){function e(t){void 0===t&&(t={}),this.options=i(i({},e.DEFAULT_OPTIONS),t),this.slides=[],this.index=0,this.loops=0,this._events={beforeEnter:function(){},beforeLeave:function(){},loopend:function(){},change:function(){}},this.options.container&&this.options.container.length&&this._buildFromHTML()}return Object.defineProperty(e,"DEFAULT_OPTIONS",{get:function(){return{loops:1/0,animate:!0,animation_class:"fade",enter_class:"fade-in"}},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"current_slide",{get:function(){return this.slides[this.index]},enumerable:!0,configurable:!0}),e.prototype.add=function(e){var i=new t.default(e);return i.index=this.slides.push(i),this.options.animate&&document.querySelector(i.selector).classList.add(this.options.animation_class),this},e.prototype.run=function(){if(this.index>=this.slides.length&&(this.index=0,this.loops++,this.loops===this.options.loops))return this._dispatchEvent("loopend"),this;this.current_slide.active=!0,this._dispatchEvent("change");try{this._slide()}catch(t){throw t}return this},e.prototype.getSlideByIndex=function(t){return this.slides[t]||null},e.prototype.getSlideByName=function(t){return this.slides.find(function(e){return e.name===t})||null},e.prototype.listen=function(t,e){if(!Object.keys(this._events).includes(t))throw new Error("[Err] Slidr.listen :: Event '"+t+"' does not exists.");return this._events[t]=e,this},e.prototype._slide=function(){var t=this;if(!this.current_slide)throw new Error("[Err] Slidr._slide :: no slide found at index "+this.index);this._dispatchEvent("beforeEnter"),this.current_slide.dispatchEvent("beforeEnter"),this.options.animate&&document.querySelectorAll("[data-slide]:not("+this.current_slide.selector+")").forEach(function(e){return e.classList.remove(t.options.enter_class)}),window.setTimeout(function(){t.options.animate&&document.querySelector(t.current_slide.selector).classList.add(t.options.enter_class),t.current_slide.dispatchEvent("shown"),window.setTimeout(function(){t._dispatchEvent("beforeLeave"),t.current_slide.dispatchEvent("beforeLeave"),t.current_slide.active=!1,t.index++,t.run()},t.current_slide.timeout)},this.options.animate?350:0)},e.prototype._buildFromHTML=function(){var t=this,e=document.querySelectorAll(this.options.container+" [data-slide]");if(!e)throw new Error("[Err] Slidr._buildFromHTML :: No slides found on container element '"+this.options.container+"'");e.forEach(function(e){var i=e.dataset;i.slide&&i.slide.length&&t.add({name:i.slide,timeout:i.timeout?parseInt(i.timeout,10):0})})},e.prototype._dispatchEvent=function(t){return this._events[t].call(this)},e}(),o=n;exports.default=o;
